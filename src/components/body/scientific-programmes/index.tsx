    ...
    <div className='scientific-programmes'>
      ...
      <div className='medal-lectures'>
        ...
        <ul className='recipients'>
          <li>
            Prof. S. P. Adhikary <span className='honors'>FNAAS</span>
          </li>
          <li>
            Prof. Rakesh Pandey <span className='honors'>FNAAS</span>
          </li>
      ...
      <div className='medal-lectures'>
        ...
        <ul className='recipients'>
          <li>
            Prof. Pramod Tandon <span className='honors'>FNASc PADMA SHRI</span>
          </li>
