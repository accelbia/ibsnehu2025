...
const Footer: React.FC = () => {
  return (
    <footer className='footer'>
      <div className='left'>
        <a
          href='https://www.indianbotsoc.org/'
          target='_blank'
        ...
        <p>
          © 2025 All India Botanical Conference Organized by Department of
          Botany and School of Life Sciences North-Eastern Hill University,
          Shillong
        </p>
      </div>
      {/* <div className="right">
